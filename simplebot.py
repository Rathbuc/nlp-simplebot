...
def send(event):
    ...
    user_input_1c = user_input.lower()
    bot_response = get_bot_response(user_input_1c)
...
chatWindow = tks.ScrolledText(baseWindow, font="Ariel")
...
userEntryBox = Text(baseWindow, bd=1, bg="white", width=38, font="Ariel")
